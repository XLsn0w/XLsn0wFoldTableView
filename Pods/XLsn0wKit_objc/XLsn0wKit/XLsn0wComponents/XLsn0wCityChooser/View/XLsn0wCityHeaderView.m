...
@interface XLsn0wCityHeaderView ()<UISearchBarDelegate>

@property (nonatomic, strong) UILabel *currentCityLabel;
@property (nonatomic, strong) XLsn0wCityButton *button;
@property (nonatomic, strong) UISearchBar *searchBar;

@end

@implementation XLsn0wCityHeaderView
...
- (void)addJFButton {
    self.button = [[XLsn0wCityButton alloc] initWithFrame:CGRectMake(self.frame.size.width - 95, self.frame.size.height - 31, 75, 21)];
...
- (void)touchUpJFButtonEnevt:(XLsn0wCityButton *)sender {
