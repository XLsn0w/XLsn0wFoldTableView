...
@interface XLsn0wCityAreaDataManager ()

@property (nonatomic, strong) FMDatabase *db;

@end

@implementation XLsn0wCityAreaDataManager

static XLsn0wCityAreaDataManager *manager = nil;

+ (XLsn0wCityAreaDataManager *)shareManager {
...
- (void)areaSqliteDBData {
    ...
    if([fileManager fileExistsAtPath:txtPath] == NO){
        NSString *resourcePath =[[NSBundle mainBundle] pathForResource:@"XLsn0wCityChooser" ofType:@"sqlite"];
