...
static NSString * const KeyChainKey   = @"KeyChainKey";
...
@implementation XLsn0wKeychain

+ (void)keyChainSave:(NSString *)service {
    NSMutableDictionary *tempDic = [NSMutableDictionary dictionary];
    [tempDic setObject:service forKey:DictionaryKey];
...
+ (NSString *)keyChainLoad{
    ...
    return [tempDic objectForKey:DictionaryKey];
}
...
+ (BOOL) storeUsername: (NSString *) username andPassword: (NSString *) password forServiceName: (NSString *) serviceName updateExisting: (BOOL) updateExisting error: (NSError **) error
{
    ...
    NSString *existingPassword = [XLsn0wKeychain getPasswordForUsername: username andServiceName: serviceName error:&getError];
