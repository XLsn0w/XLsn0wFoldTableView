...
@implementation XLsn0wNineSquarerIndicator
...
- (void)initSubviews {
    ...
    for (int i = 0; i < 9; i++) {
        ...
        [btn setImage:[XLsn0w getCustomBundleWithFileName:@"XLsn0wKit_objc" bundleImageName:@"gesture_indicator_normal"] forState:UIControlStateNormal];
        [btn setImage:[XLsn0w getCustomBundleWithFileName:@"XLsn0wKit_objc" bundleImageName:@"gesture_indicator_selected"] forState:UIControlStateSelected];
        [self addSubview:btn];
