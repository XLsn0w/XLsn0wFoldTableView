 ...
 */
+ (instancetype)shared {
    static XLNetManager * manager = nil;
...
+(void)requestWithType:(HttpRequestType)type withUrlString:(NSString *)urlString withParaments:(id)paraments withSuccessBlock:(requestSuccess)successBlock withFailureBlock:(requestFailure)failureBlock progress:(downloadProgress)progress
{
    ...
    switch (type) {
        ...
        case HttpRequestTypeGet:
        {
            ...
            [[XLNetManager shared] GET:urlString parameters:paraments progress:^(NSProgress * _Nonnull downloadProgress) {
            ...
            
        {
            ...
            [[XLNetManager shared] POST:urlString parameters:paraments progress:^(NSProgress * _Nonnull uploadProgress) {
...
+(void)cancelAllRequest {
    [[XLNetManager shared].operationQueue cancelAllOperations];
...
+(void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string
{
    ...
    NSString * urlToPeCanced = [[[[XLNetManager shared].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
    
    
    for (NSOperation * operation in [XLNetManager shared].operationQueue.operations) {
