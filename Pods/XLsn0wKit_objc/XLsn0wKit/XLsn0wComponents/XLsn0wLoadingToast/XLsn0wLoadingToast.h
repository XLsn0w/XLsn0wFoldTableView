...
@protocol XLsn0wLoadingToastDelegate <NSObject>
 ...
 */
- (void)hudWasHidden:(XLsn0wLoadingToast *)hud;
 ...
 */
@interface XYQRoundProgressView : UIView
 ...
 */
@interface XYQBarProgressView : UIView
 ...
 * animations while disappearing.
 * @return the nuXYQer of HUDs found and removed.
 *
 * @see hideHUDForView:animated:
 * @see animationType
 */
 ...
 *
 * @param view The view that is going to be searched.
 * @return All found HUD views (array of XYQProgressHUD objects).
 */
