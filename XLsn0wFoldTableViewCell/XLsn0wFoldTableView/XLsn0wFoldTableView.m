...
@interface XLsn0wFoldTableView () <UITableViewDataSource, UITableViewDelegate>
...
@implementation XLsn0wFoldTableView
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else
    {
        ...
        UITableViewCell *cell = [_foldDelegate tableView:(XLsn0wFoldTableView *)tableView cellForSubRowAtIndexPath:correspondingIndexPath];
