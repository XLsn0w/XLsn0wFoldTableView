...
- (void)customCell {
    ...
    [_todayPower mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_nowPower.mas_right).offset(50);
        make.height.mas_equalTo(15);
        make.top.mas_equalTo(_name.mas_bottom).offset(10);
    }];
    ...
    [_allPower mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_todayPower.mas_right).offset(50);
        make.height.mas_equalTo(15);
        make.top.mas_equalTo(_name.mas_bottom).offset(10);
    }];
    ...
    [_nowPowerStr mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_iconImageView.mas_right).offset(10);
        make.height.mas_equalTo(15);
        make.top.mas_equalTo(_nowPower.mas_bottom).offset(10);
    }];
    ...
    [_todayPowerStr mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_nowPower.mas_right).offset(50);
        make.height.mas_equalTo(15);
        make.top.mas_equalTo(_todayPower.mas_bottom).offset(10);
    }];
    ...
    [_allPowerStr mas_makeConstraints:^(MASConstraintMaker *make) {
        make.left.mas_equalTo(_todayPower.mas_right).offset(50);
        make.height.mas_equalTo(15);
        make.top.mas_equalTo(_allPower.mas_bottom).offset(10);
    }];
